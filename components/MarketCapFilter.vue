  ...
  <div class="relative" ref="filterRef">
    ...
    <Teleport to="body">
      <div
        ...
        ref="popupRef"
        :style="popupStyle"
        class="fixed bg-[#1a1d2e] border border-gray-700/50 rounded-xl shadow-2xl z-[9999] p-6 market-cap-popup w-[380px] min-w-[380px]"
      >
        <!-- Title -->
        <h3 class="text-white font-bold text-lg mb-6">Market Cap</h3>
